...
telforn='$telforn',fotologo='$prod',prod='$prod',cepforn='$cepforn',enderecoforn='$enderecoforn',numero='$numero',complforn='$complforn ',bairroforn='$bairroforn',cidadeforn='$cidadeforn',msociaisforn='$msociaisforn',quemsoueu='$quemsoueu'
