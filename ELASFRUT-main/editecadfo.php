                ...
                <form action = "salveEdite.php"  method = "post">
                    <h4>Editar Fornecedores </h4> <hr>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-3">
                                <label for="exampleFormControlTextarea1" class="form-label" name ="quemsoueu" value="<?php echo $quemsoueu ?>"> <strong>Conte-nos sobre você! </strong></label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>

                        <input type="hidden" name="id" value="<?php echo $id?>">
                        <input type = "submit" class = "btn" name="update" id="update"   >
                       <a href="configlistafornecedor.php">Voltar</a>
